<template>
  <div class="shop-header">
    ...
    <div class="shop-content" >
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <i class="content-icon" @click="shopShow=true"></i>
        </h2>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="supportShow=true">
      <div class="discounts-left">
        <div class="activity" :class="supportCalsses[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="activity-sheet-content" >
        ...
        <ul class="list"> 
          <li 
              ...
              class="activity-item "
              :class="supportCalsses[item.type]"
          >
            <span class="content-tag">
...
export default {
  ...
  data(){
    return {  // 对应每个不同的优惠
      supportCalsses:['activity-green','activity-red','activity-orange'],
      toggleShopShow:true,
      shopShow:false,
      supportShow:false
    }
